...
/** Mount once in app/layout.tsx, above everything that uses <Tooltip>. */
...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <TooltipPrimitive.Portal>
    <TooltipPrimitive.Content
      ...
      className={cn(
        "z-50 rounded border border-border bg-panel-raised px-2 py-1 text-meta text-text shadow-popover",
