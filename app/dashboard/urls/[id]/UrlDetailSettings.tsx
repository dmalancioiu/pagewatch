...
import { Clock, Globe, Trash2, Save, Loader2, AlertCircle, MessageSquareText } from 'lucide-react'
...
export function UrlDetailSettings({ url }: { url: any; latestSnapshotUrl: string | null }) {
  ...
  const zones = Array.isArray(url.zones) ? url.zones : []
